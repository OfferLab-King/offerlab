export const analyticsEventDefinitions = {
  ...
  employer_apply_click: { allowedProperties: [] as const },
  job_filter_used: { allowedProperties: [] as const },
  job_match_completed: { allowedProperties: [] as const },
  job_match_started: { allowedProperties: [] as const },
  job_saved: { allowedProperties: [] as const },
  job_view: { allowedProperties: [] as const },
  jobs_search: { allowedProperties: [] as const },
  learning_path_completed: { allowedProperties: [] as const },
  learning_path_opened: { allowedProperties: [] as const },
  learning_path_started: { allowedProperties: [] as const },
  learning_path_stopped: { allowedProperties: [] as const },
